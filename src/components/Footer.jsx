...
import { FaBehance, FaDribbble, FaFacebook, FaLinkedinIn } from 'react-icons/fa';
  ...
  return (
    <div className='w-full bg-white py-24'>
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-5 max-[780px]:grid-cols-2 gap-8 max-w-[600px]'>
            ...
            <h3 className='py-2 text-[#6D737A]'>Praesent nulla massa, hendrerit <br /> vestibulum gravida in, feugiat auctor felis.</h3>
            ...
            <form className='py-4'>
                ...
                />
                <button className='max-[780px]:w-full my-4 px-5 py-3 text-white font-semibold bg-[#20B486] rounded-md'>Subscribe</button>
            </form>
            </div>
